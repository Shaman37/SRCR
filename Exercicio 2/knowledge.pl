...
cuidado(1,'2017-12-28',12,15,'Intoxicação alimentar',61.23).
cuidado(2,'2018-01-12',8,14,'Perna partida',33.97).
cuidado(3,'2018-01-15',5,12,'Alergia de pelo',32.3).
...
cuidado(8,'2018-02-19',6,12,'Exame Polmunar',71.03).
cuidado(9,'2018-02-22',14,6,'Vomitos',54.31).
cuidado(10,'2018-02-27',9,6,'Febre',58.16).
cuidado(11,'2018-03-02',2,2,'Pré-natal de risco',53.29).
cuidado(12,'2018-03-02',6,10,'Ferimento no abdomen',89.71).
cuidado(13,'2018-03-02',9,9,'Amigdalite',43.39).
cuidado(14,'2018-03-02',9,14,'Dedo fraturado',75.3).
...
cuidado(18,'2018-03-10',7,7,'Radiografia Perna',45.6).
